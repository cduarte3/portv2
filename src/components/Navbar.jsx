...
export default function Navbar() {
  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white">
      ...
      <div className={!nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#141630]' : 'fixed left-[-100%] top-0 w-[60%] h-full border-r border-r-gray-900 bg-blue-800'}>
